 ...
 */
export const APP_NAME: string = 'pulse-champion';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'High pulse, High earn';
 ...
 */
export const APP_TAGS: string[] = ['celo', 'finance', 'earn'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'launch pulse';
